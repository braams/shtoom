...
class ShtoomMainWindow(QMainWindow):
    def __init__(self,parent = None,name = None,fl = 0):
        ...
        self.textLabel4.setProperty("alignment",QVariant(QLabel.AlignBottom | QLabel.AlignRight))

        self.statusLabel = QLabel(self.centralWidget(),"statusLabel")
        self.statusLabel.setProperty("geometry",QVariant(QRect(60,121,250,20)))
        self.statusLabel.setProperty("backgroundMode",QVariant(QLabel.PaletteBrightText))
        ...
        self.debuggingTextEdit.setProperty("geometry",QVariant(QRect(0,170,410,120)))
        ...
        self.dtmfButton5.setProperty("geometry",QVariant(QRect(30,30,16,16)))
        ...
        self.appVersion = QLabel(self.centralWidget(),"appVersion")
        self.appVersion.setProperty("geometry",QVariant(QRect(290,300,120,31)))
        ...
        self.appVersion.setProperty("alignment",QVariant(QLabel.AlignVCenter | QLabel.AlignRight))
        ...
        self.resize(QSize(421,385).expandedTo(self.minimumSizeHint()))
